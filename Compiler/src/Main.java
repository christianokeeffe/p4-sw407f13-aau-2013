...
public class Main{
	...
	public static void main(String[] args) {
		String file = "C:/Users/Aleksander/Documents/P4/Personlige mapper/Diktatoren/mainprogram.splad";
		...
		ArduinoCompiler AUploader = new ArduinoCompiler();
		AUploader.initialize();
