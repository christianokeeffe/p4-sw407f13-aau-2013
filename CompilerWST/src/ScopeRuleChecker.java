...
public class ScopeRuleChecker extends AbstractParseTreeVisitor<String> implements SPLADVisitor<String>{
	...
	public String visitFrom(SPLADParser.FromContext ctx) {
		...
		return visit(ctx.assign()) + visit(ctx.expr()) 
				  +	visit(ctx.plusminusorempty()) + visit(ctx.block());
	}
