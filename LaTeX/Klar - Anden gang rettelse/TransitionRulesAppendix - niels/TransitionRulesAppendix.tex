...
\begin{longtable}{l l}
\longtablesetting{2}
[ROOT] & $\dfrac{\begin{matrix}  \langle R_1, sto, env_p, evp_v \rangle \rightarrow (sto'', env_p'', evp_v'') \\ \langle R_2, sto'', env_p'', evp_v'' \rangle \rightarrow (sto', env_p', evp_v') \end{matrix}}{\langle R_1 \; R_2, sto, env_p, evp_v \rangle \rightarrow (sto', env_p', evp_v')}$ \\
~ & ~ \\
