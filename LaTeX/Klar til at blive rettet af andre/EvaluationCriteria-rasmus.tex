...
To steer the development of the compiler in the wanted direction and to express which areas that we in the project group finds important to the compiler. To express this priorities we uses a table, see table \ref{tab:criteria} were we rate each criteria by the importance compare to each other.
