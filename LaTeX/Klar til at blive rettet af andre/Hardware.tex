...
%ret herfra
An alternative to RFID is NFC (Near Field Communication). NFC uses radio communication like the RFID, but unlike RFID is the communication between two NFC devises two-way. A NFC can also read passive NFC tags and in that way replace the RFID. We have chosen not to use the NFC devises since we have no need of the two-way communication.
