...
\figur{0.8}{OverviewCompiler.PNG}{This is an abstract overview of how the compiler is structured. The figure is from \citep{CraftingACompiler}}{fig:OverviewCompiler} 
