...
\figur{0.6}{OverviewCompiler.PNG}{This is an abstract overview of how the compiler is structured \citep{OverviewCompiler2}.}{fig:OverviewCompiler} 
...
\figur{0.8}{OverviewCompiler2.PNG}{This is an more detailed overview of how the compiler is structured \citep{CraftingACompiler}.}{fig:OverviewCompiler2}