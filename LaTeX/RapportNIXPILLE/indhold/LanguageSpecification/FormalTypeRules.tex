...
This section will follow up on the informal description of our type rules. Expressions can be seen on \ref{tab:expressions}, declarations can be seen on \ref{tab:declarations} and statements can be seen \ref{tab:statements}.
