...
With the drink type defined above, we should now focus on, how to define an ingredient. In the psychical machine, an ingredient will in most cases be a liquid in a container. It could also be leaves or fruit, also in a container. 
