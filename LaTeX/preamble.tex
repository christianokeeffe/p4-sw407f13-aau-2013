...
\makeevenhead{custom}{\leftmark}{P4, Aalborg Universitet}{Group SW407F13} % Definerer lige siders sidehoved efter modellen \makeevenhead{Navn}{Venstre}{Center}{Højre}
\makeoddhead{custom}{Group SW407F13}{P4, Aalborg Universitet}{\leftmark} % Definerer ulige siders sidehoved efter modellen \makeoddhead{Navn}{Venstre}{Center}{Højre}
...
{\def\fooNoI{#1} \def\fooNoII{#2}\noindent \begin{minipage}{\textwidth}\begin{mdframed}\begin{lstlisting}}{\end{lstlisting}\end{mdframed}\lstcapt{\fooNoII}\label{lst:\fooNoI}\end{minipage}}
