...
\begin{itemize}
	% før \item \textbf{How can a programming language be developed, which makes it easy for the hobby programmer to program drink machines based on Arduino platforms?}
...
\begin{itemize}
	%før \item \textbf{How can a programming language be specified, which makes it easy for novice programmers to learn it?}
