...
This section contains the BNF for the programming language of this project; SPLAD. It is clear that the BNF begins with the non-terminal program. The program terminal can then be derived in a number of ways, to represent a specific program.  
