...
%RET START%
\item \textbf{Expressivity:} Short hands has not been implemented in SPLAD, this is to increase the readability of the program, as described in listing \ref{lst:ifstmtnormal}.
