...
\subsection{Root statements}
The root statements are like regular statements (described below in section \ref{sec:statements}), but ensures that all procedure declaration will be make in the global scope. 
