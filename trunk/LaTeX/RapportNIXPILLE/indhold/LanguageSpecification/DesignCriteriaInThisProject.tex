...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{|l|R|}
		...
		Simplicity				& When a program e.g. have a small number of basic constructs, and it is simple in the way that it have only one way to 									accomplish a particular operation\\ \hline
