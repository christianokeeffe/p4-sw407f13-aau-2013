...
morekeywords={int, container, string, bool, double, HIGH, LOW, true, false, nothing, INPUT, OUTPUT, const, drink, function, begin, end, return, using, if, else, case, switch, while, from, to, step, call, break, default, AND, OR, is, of, add, remove, as, but}
}
...
\makeoddhead{nychapter}{Group SW407F13}{P4, Aalborg University}{\leftmark}
\makeevenhead{nychapter}{Group SW407F13}{P4, Aalborg University}{\leftmark}
...
{\def\fooNoI{#1} \def\fooNoII{#2}\noindent\newline \begin{minipage}{\textwidth}\begin{mdframed}}{\end{mdframed}\lstcapt{\fooNoII}\label{lst:\fooNoI}\end{minipage}}
