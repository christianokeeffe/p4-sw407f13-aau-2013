...
\figur{0.8}{OverviewCompiler1.PNG}{This is an overview of how the compiler is structured.}{fig:OverviewCompiler1}
...
\figur{0.8}{OverviewCompiler.PNG}{This is another overview of how the compiler is structured.}{fig:OverviewCompiler2}
