...
\caption{Statements}
\end{longtable}
\fxfatal{OPDATER BLOCK og skriv om Q}
\begin{landscape}
\begin{longtable}{l l}
\longtablesetting{2}
...
[ARRAY-DEC] & $\dfrac{\langle D_A, env_V[r \mapsto l, \text{next} \mapsto l + v + 1],  sto[l \mapsto v] \rangle \rightarrow_{DA} (env_V', sto')}{\langle \text{array} \; r[a_1], D_A, env_V, sto \rangle \rightarrow_{DA} (env_V', sto')}$ \\
~ & ~ \\
